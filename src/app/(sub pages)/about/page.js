  ...
  return (
    <>
      ...
      <div className="relative w-full h-screen flex flex-col items-center justify-center">
        <div className="absolute w-full flex flex-col items-center text-center top-[60%] -translate-y-1/2 left-1/2 -translate-x-1/2">
          <h1 className="font-bold text-9xl text-accent">Ilija Košanin</h1>
